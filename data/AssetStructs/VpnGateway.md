...
type VpnGatewayInfo struct {
	...
	RouteEntry []*VpnRouteEntry `json:"routeEntry" bson:"routeEntry"`
}
...
type VpnRouteEntry struct {
	RouteEntry
	IPsecInfo VpnRouteEntryIPsecInfo `json:"ipsecInfo" bson:"ipsecInfo"`
}
...
// VpnRouteEntryIPsecInfo
type VpnRouteEntryIPsecInfo struct {
